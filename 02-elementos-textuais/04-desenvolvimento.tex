...
\end{figure}
\vspace*{-0,9cm}
{\raggedright \fonte{Dispon\'{i}vel em: <https://https://www.sisgou.seds.al.gov.br>. Acesso em: 10 ago. 2020.}}\\
...
O PostgreSQL foi pioneiro em muitos conceitos que s\'{o} se tornaram dispon\'{i}veis em alguns sistemas de bancos de dados comerciais muitos anos depois.
...
\end{figure}
\vspace*{-0,9cm}
{\raggedright \fonte{Dispon\'{i}vel em: <https://https://www.hitachivantara.com/en\_us/pdf/datasheet/pentaho-business-analytics-platform-datasheet.pdf>. Acesso em: 11 ago. 2020.}}\\
...
Os conjunto de ferramentas do \textit{Pentaho} incluem componentes baseados na web e ferramentas de \textit{design}. Os componentes e 
...
\end{figure}
\vspace*{-0,9cm}
{\raggedright \fonte{\cite{pentaho-pdi-hitachi-vantara}}} \\
...
Para melhorar o entendimento usamos um nomenclatura padr\~{a} para os arquivos das transforma\c{c}\~{o}es, formato ``.ktr'', e do \textit{Job}\index{job}\footnote{\textit{Job}: \'{e} o processo que une todas \`{a}s transforma\c{c}\~{o}es para uma execu\c{c}\~{a}o de todas dentro do PDI}, formato ``.kjb'', para ajudar no desenvolvimento do DW/BI. 
