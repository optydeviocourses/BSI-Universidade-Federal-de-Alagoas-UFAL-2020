...
\begin{document}
    ...
    % Elementos textuais
    \textual
    \include{./02-elementos-textuais/01-introducao}
    \include{./02-elementos-textuais/02-fundamentacao}
    \include{./02-elementos-textuais/03-metodologia}      
    \include{./02-elementos-textuais/04-desenvolvimento}
    \include{./02-elementos-textuais/05-analise-discussao}      
    \include{./02-elementos-textuais/06-consideracoes-finais}
